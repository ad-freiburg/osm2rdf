...
# find include path
find_path(BOOSTSTATICASSERT_INCLUDE_DIR boost/static_assert.hpp
    PATH_SUFFIXES include
    PATHS ${CMAKE_SOURCE_DIR}/src/vendor/boost/static_assert
)

set(BOOSTSTATICASSERT_INCLUDE_DIRS "${BOOSTSTATICASSERT_INCLUDE_DIR}")

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(BoostStaticAssert
    REQUIRED_VARS BOOSTSTATICASSERT_INCLUDE_DIR
