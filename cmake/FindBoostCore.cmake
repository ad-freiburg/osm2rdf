...
# find include path
find_path(BOOSTCORE_INCLUDE_DIR boost/core/enable_if.hpp
    PATH_SUFFIXES include
    PATHS ${CMAKE_SOURCE_DIR}/src/vendor/boost/core
)

set(BOOSTCORE_INCLUDE_DIRS "${BOOSTCORE_INCLUDE_DIR}")

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(BoostCore
    REQUIRED_VARS BOOSTCORE_INCLUDE_DIR
