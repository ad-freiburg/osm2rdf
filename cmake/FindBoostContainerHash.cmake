...
# find include path
find_path(BOOSTCONTAINERHASH_INCLUDE_DIR boost/container_hash/hash.hpp
    PATH_SUFFIXES include
    PATHS ${CMAKE_SOURCE_DIR}/src/vendor/boost/container_hash
)

set(BOOSTCONTAINERHASH_INCLUDE_DIRS "${BOOSTCONTAINERHASH_INCLUDE_DIR}")

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(BoostContainerHash
    REQUIRED_VARS BOOSTCONTAINERHASH_INCLUDE_DIR
