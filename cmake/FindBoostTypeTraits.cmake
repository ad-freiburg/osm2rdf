...
# find include path
find_path(BOOSTTYPETRAITS_INCLUDE_DIR boost/type_traits.hpp
    PATH_SUFFIXES include
    PATHS ${CMAKE_SOURCE_DIR}/src/vendor/boost/type_traits
)

set(BOOSTTYPETRAITS_INCLUDE_DIRS "${BOOSTTYPETRAITS_INCLUDE_DIR}")

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(BoostTypeTraits
    REQUIRED_VARS BOOSTTYPETRAITS_INCLUDE_DIR
