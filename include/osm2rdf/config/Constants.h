...
const static inline std::string DUMMY_GRIDSIZE_INFO = "Grid size for dummy area grid";
const static inline std::string DUMMY_GRIDSIZE_OPTION_SHORT = "";
const static inline std::string DUMMY_GRIDSIZE_OPTION_LONG = "dummy-area-grid-size";
const static inline std::string DUMMY_GRIDSIZE_OPTION_HELP =
    "Grid size of dummy area grid used to break up geometries with an area larger than a single grid cell";

const static inline std::string DUMMY_MIN_INTERSECT_AREA_OPTION_INFO = "Grid size for dummy area grid";
const static inline std::string DUMMY_MIN_INTERSECT_AREA_OPTION_SHORT = "";
const static inline std::string DUMMY_MIN_INTERSECT_AREA_OPTION_LONG = "dummy-area-min-intersect-size";
const static inline std::string DUMMY_MIN_INTERSECT_AREA_OPTION_HELP =
    "Minimum size of dummy areas generated by intersecting named areas A, B and taking C = A cut B, D = A - C and E = A - C as dummy areas.";
