...
osm2rdf::geometry::Area getDefaultObject() { return osm2rdf::geometry::Area(); }

// ____________________________________________________________________________
osm2rdf::geometry::Area getFilledObject() {
  osm2rdf::geometry::Area obj;
  obj.resize(2);
...
TEST(GEOMETRY_Area, serializationBinary) {
  ...
  osm2rdf::geometry::Area loadedDefaultObject;
