...
#include "osm2rdf/geometry/Linestring.h"
...
osm2rdf::geometry::Linestring getDefaultObject() {
  return osm2rdf::geometry::Linestring();
}

// ____________________________________________________________________________
osm2rdf::geometry::Linestring getFilledObject() {
  osm2rdf::geometry::Linestring obj;
...
TEST(GEOMETRY_Linestring, serializationBinary) {
  ...
  osm2rdf::geometry::Linestring origDefaultObject = getDefaultObject();
  osm2rdf::geometry::Linestring origFilledObject = getFilledObject();
  osm2rdf::geometry::Linestring loadedDefaultObject;
  osm2rdf::geometry::Linestring loadedFilledObject;
