...
TEST(OSM_FactHandler, wayAddWayNodeOrder) {
  ...
  ASSERT_EQ(
      ...
      "osmway:42 osmkey:city \"Freiburg\" .\n"
      "osmway:42 osm2rdf:facts \"1\"^^xsd:integer .\nosmway:42 "
      "osmway:node_ref _:0_0 .\n_:0_0 osmway:node_id osmnode:1 .\n_:0_0 "
      "osmway:node_pos \"0\"^^xsd:integer .\nosmway:42 osmway:node_ref _:0_1 "
      ".\n_:0_1 osmway:node_id osmnode:2 .\n_:0_1 osmway:node_pos "
      "\"1\"^^xsd:integer .\nosmway:42 geo:hasGeometry osm2rdf:way_42 "
      ".\nosm2rdf:way_42 geo:asWKT \"LINESTRING(48 7.5,48.1 "
...
TEST(OSM_FactHandler, wayAddWayNodeSpatialMetadataLongerWay) {
  ...
  ASSERT_EQ(
      ...
      "\"1\"^^xsd:integer .\n_:0_0 osmway:next_node osmnode:2 .\n_:0_0 "
      "osmway:next_node_distance \"15657.137001\"^^xsd:decimal .\nosmway:42 "
      "osmway:node_ref _:0_2 .\n_:0_2 osmway:node_id osmnode:4 .\n_:0_2 "
      "osmway:node_pos \"2\"^^xsd:integer .\n_:0_1 osmway:next_node "
      "osmnode:4 .\n_:0_1 osmway:next_node_distance "
      "\"11119.490351\"^^xsd:decimal .\nosmway:42 osmway:node_ref _:0_3 .\n_:0_3 "
      "osmway:node_id osmnode:3 .\n_:0_3 osmway:node_pos \"3\"^^xsd:integer "
