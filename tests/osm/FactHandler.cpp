...
TEST(OSM_FactHandler, areaFromWay) {
  ...
  ASSERT_EQ(
      ...
      "osmway:21 osm2rdf:convex_hull \"POLYGON((48.0 7.5,48.0 7.6,48.1 "
      "7.6,48.1 7.5,48.0 7.5))\"^^geo:wktLiteral .\n"
      "osmway:21 osm2rdf:envelope \"POLYGON((48.0 7.5,48.0 7.6,48.1 "
      "7.6,48.1 7.5,48.0 7.5))\"^^geo:wktLiteral .\n"
      "osmway:21 osm2rdf:obb \"POLYGON((48.0 7.6,48.1 7.6,48.1 7.5,48.0 "
...
TEST(OSM_FactHandler, wayAddWayNodeGeoemtry) {
  ...
  ASSERT_EQ(
      ...
      "osmnode:2 geo:hasGeometry osm2rdf:osmnode_2 .\n"
...
TEST(OSM_FactHandler, wayAddWayNodeSpatialMetadataLongerWay) {
  ...
  ASSERT_EQ(
      ...
      "osmway:42 geo:hasGeometry osm2rdf:osmway_42 .\n"
      "osm2rdf:osmway_42 geo:asWKT \"LINESTRING(48.0 7.5,48.1 7.6,48.1 7.5,48.0 "
      "7.5)\"^^geo:wktLiteral .\n"
      "osmway:42 osm2rdf:convex_hull \"POLYGON((48.0 7.5,48.1 7.6,48.1 "
      "7.5,48.0 7.5))\"^^geo:wktLiteral .\n"
      "osmway:42 osm2rdf:envelope \"POLYGON((48.0 7.5,48.0 7.6,48.1 "
      "7.6,48.1 7.5,48.0 7.5))\"^^geo:wktLiteral .\n"
      "osmway:42 osm2rdf:obb \"POLYGON((48.1 7.6,48.1 7.6,48.0 7.5,48.0 "
