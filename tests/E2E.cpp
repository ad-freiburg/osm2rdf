...
TEST(E2E, singleNodeWithTags) {
  ...
  ASSERT_THAT(printedData,
              ::testing::HasSubstr(
                  "osm2rdfgeom:osmnode_240092010 geo:asWKT \"POINT(7.8494005 "
...
TEST(E2E, singleWayWithTagsAndNodes) {
  ...
  ASSERT_THAT(printedData,
              ::testing::HasSubstr("osm2rdfgeom:osmway_98284318 geo:asWKT "
...
TEST(E2E, osmWikiExample) {
  ...
  ASSERT_THAT(printedData, ::testing::HasSubstr(
                               "osm2rdfgeom:osmway_26659127 geo:asWKT \"LINESTRING("));
  ASSERT_THAT(printedData,
...
TEST(E2E, building51TTL) {
  ...
  ASSERT_THAT(
      printedData,
      ::testing::HasSubstr("osm2rdfgeom:osmway_98284318 geo:asWKT \"LINESTRING(7"));
  ASSERT_THAT(printedData, ::testing::HasSubstr("7)\"^^geo:wktLiteral .\n"));
  ASSERT_THAT(
      printedData,
      ::testing::HasSubstr(
          "osm2rdfgeom:osmway_98284318 geo:asWKT \"POLYGON((7"));
...
TEST(E2E, tf) {
  ...
  ASSERT_THAT(printedData, ::testing::HasSubstr(
                               "osm2rdfgeom:osmway_4498466 geo:asWKT \"LINESTRING(7"));
  ASSERT_THAT(
      printedData,
      ::testing::HasSubstr(
          "osm2rdfgeom:osmway_4498466 geo:asWKT \"POLYGON((7"));
