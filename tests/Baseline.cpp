...
TEST(std, set_difference) {
  {
    ...
    std::set_difference(i1.begin(), i1.end(), i1.begin(), i1.end(), std::back_inserter(result));
  ...
  }
  {
    ...
    std::set_difference(i2.begin(), i2.end(), i2.begin(), i2.end(), std::back_inserter(result));
  ...
  }
  {
    ...
    std::set_difference(i1.begin(), i1.end(), i2.begin(), i2.end(), std::back_inserter(result));
  ...
  }
  {
    ...
    std::set_difference(i2.begin(), i2.end(), i1.begin(), i1.end(), std::back_inserter(result));
